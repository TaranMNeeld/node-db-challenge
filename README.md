...
Answer: Relational Databases are much different than SQL, but they work together as a whole. Relational Databases are made of tables that have different columns and rows. SQL is the computer language that manipulates these tables. To be explicit, Relational Databases are the resource data, and SQL is a computer language.

- [ ] Why do tables need a `primary key`?
Answer: Each table needs a primary key because the items on the table to be unique in some way, and the primary key in different for every item on the table.

- [ ] What is the name given to a table column that references the primary key on another table.
Answer: Foreign key

- [ ] What do we need in order to have a _many to many_ relationship between two tables.
Answer: We will need an Intermediary Table.
